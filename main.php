...
<head>
 ...
 <title>Jquery custom Tabs+slide bar with slide page</title>
	   ...
	   $('.tab').on('touchstart', function(){
		...
		$('#page2').on('touchmove', function(event){
		  ...
		  $('#page3').css({
			  ...
			  var diff  = 33.33 + Change;
			  
             if(diff < 60){
				  
				 $('.slide-bar').css({'left':'+'+diff+'%'});  
			  }
			  
			  var diffs = 33.33 + Change;
			  
			  if(diffs <= 10){
				  
			       $('.slide-bar').css({'left':'10%'}); 
